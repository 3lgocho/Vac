...
front/
  ...
  components/
    registro/
      modales/
        BiologicosModal.tsx
        EtniaSearchModal.tsx
        VacunaModal.tsx
      SeccionAlergias.tsx
      SeccionBiologica.tsx
      SeccionDireccion.tsx
      SeccionEtnia.tsx
      SeccionGruposEspeciales.tsx
    ...
    ui/
      ...
      icon-symbol.tsx
    Calendario.tsx
    ConfirmacionFormulario.tsx
    ProgressBarRegistro.tsx
    themed-text.tsx
    themed-view.tsx
    top_bar.tsx
  constants/
    etnias.ts
    grupos_especiales.ts
    theme.ts
  hooks/
    use-color-scheme.ts
...
## File: back/src/handlers
````

````

## File: back/src/main.rs
````rust
...
## File: back/src/models
````

````

## File: back/src/models.rs
````rust
// back/src/models.rs
...
sqlx = { version = "0.8.6", features = ["postgres", "runtime-tokio-rustls", "macros", "chrono", "json"] }
...
## File: front/.vscode/extensions.json
````json
...
## File: front/app/(tabs)/agenda/index.tsx
````typescript
...
## File: front/app/(tabs)/pacientes/[id].tsx
````typescript
...
## File: front/app/(tabs)/pacientes/index.tsx
````typescript
...
## File: front/app/(tabs)/reportes/index.tsx
````typescript
...
## File: front/app/(tabs)/_layout.tsx
````typescript
...
## File: front/app/registro/_layout.tsx
````typescript
...
## File: front/app/registro/paso1.tsx
````typescript
...
## File: front/app/registro/paso2.tsx
````typescript
...
## File: front/app/registro/paso3.tsx
````typescript
...
## File: front/components/registro/modales/BiologicosModal.tsx
````typescript
...
## File: front/components/registro/modales/EtniaSearchModal.tsx
````typescript
...
## File: front/components/registro/modales/VacunaModal.tsx
````typescript

````

## File: front/components/registro/SeccionAlergias.tsx
````typescript
...
## File: front/components/registro/SeccionBiologica.tsx
````typescript
...
## File: front/components/registro/SeccionDireccion.tsx
````typescript
...
## File: front/components/registro/SeccionEtnia.tsx
````typescript
...
## File: front/components/registro/SeccionGruposEspeciales.tsx
````typescript
...
## File: front/components/registro/SeccionIdentidad.tsx
````typescript
...
## File: front/components/registro/SeccionVacunas.tsx
````typescript
...
## File: front/components/ui/collapsible.tsx
````typescript
...
## File: front/components/ui/icon-symbol.ios.tsx
````typescript
...
## File: front/components/ui/icon-symbol.tsx
````typescript
...
## File: front/components/Calendario.tsx
````typescript
...
## File: front/components/ConfirmacionFormulario.tsx
````typescript
...
## File: front/components/ProgressBarRegistro.tsx
````typescript
...
## File: front/components/themed-text.tsx
````typescript
...
## File: front/components/themed-view.tsx
````typescript
...
## File: front/components/top_bar.tsx
````typescript
import React, { useState } from 'react';
...
## File: front/constants/etnias.ts
````typescript
...
## File: front/constants/grupos_especiales.ts
````typescript
...
## File: front/hooks/use-color-scheme.ts
````typescript
export { useColorScheme } from 'react-native';
````

## File: front/hooks/use-color-scheme.web.ts
````typescript
...
## File: front/hooks/use-theme-color.ts
````typescript
/**
...
## File: front/hooks/useBiologicos.ts
````typescript
...
## File: front/hooks/useCalculoEdad.ts
````typescript
...
## File: front/hooks/usePacientes.ts
````typescript
import { useState, useCallback } from 'react';
...
## File: front/hooks/useSubmitPaciente.ts
````typescript
...
## File: front/scripts/reset-project.js
````javascript
#!/usr/bin/env node
...
## File: front/store/registroStore.ts
````typescript
...
## File: front/nativewind-env.d.ts
````typescript
...
````
<<<<<<< HEAD
# Ignorar dependencias de Node en el front
/front/node_modules/

# Ignorar binarios compilados de Rust en el back
/back/target/
...
node_modules/
.env
>>>>>>> 6cfde1ecf716dcc85def6f0c66c34e013f28f6b2
````
